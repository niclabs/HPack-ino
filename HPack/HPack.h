...
public:
	...
	uint32_t search_header(char* name, char* value);
private:
	uint32_t first;
	uint32_t next;
	uint32_t max_size;
...
public:
	...
	HeaderBuffer* hb;
	uint32_t search_header(char* name, char* value);
	uint32_t search_header_in_static_table(char* name, char* value);
	uint32_t search_header_in_dyn_table(char* name, char* value);

	HeaderPair * findEntry(uint32_t index);

	EncodedData* encode(char *name, bool nameHuffman, char* value, bool valueHuffman, bool indexing, bool neverIndexed);
	void decode(char* encoded_data, uint32_t encoded_size);
	HeaderPair* getNextHeaderPair();
...
private:
	...
	uint32_t binary_search_static_table(char*name, char*value, int start, int end);
};
...
const char name_27[] PROGMEM = "content-length";
const char name_28[] PROGMEM = "content-location";
const char name_29[] PROGMEM = "content-range";
const char name_30[] PROGMEM = "content-type";

const char name_31[] PROGMEM = "cookie";
const char name_32[] PROGMEM = "date";
const char name_33[] PROGMEM = "etag";
const char name_34[] PROGMEM = "expect";
const char name_35[] PROGMEM = "expires";

const char name_36[] PROGMEM = "from";
const char name_37[] PROGMEM = "host";
const char name_38[] PROGMEM = "if-match";
const char name_39[] PROGMEM = "if-modified-since";
const char name_40[] PROGMEM = "if-none-match";

const char name_41[] PROGMEM = "if-range";
const char name_42[] PROGMEM = "if-unmodified-since";
const char name_43[] PROGMEM = "last-modified";
const char name_44[] PROGMEM = "link";
const char name_45[] PROGMEM = "location";

const char name_46[] PROGMEM = "max-forwards";
const char name_47[] PROGMEM = "proxy-authenticate";
const char name_48[] PROGMEM = "proxy-authorization";
const char name_49[] PROGMEM = "range";
const char name_50[] PROGMEM = "referer";

const char name_51[] PROGMEM = "refresh";
const char name_52[] PROGMEM = "retry-after";
const char name_53[] PROGMEM = "server";
const char name_54[] PROGMEM = "set-cookie";
const char name_55[] PROGMEM = "strict-transport-security";

const char name_56[] PROGMEM = "transfer-encoding";
const char name_57[] PROGMEM = "user-agent";
const char name_58[] PROGMEM = "vary";
const char name_59[] PROGMEM = "via";
const char name_60[] PROGMEM = "www-authenticate";
